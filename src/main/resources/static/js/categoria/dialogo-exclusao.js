$('#dialogoExclusaoCategoria').on('show.bs.modal', function(event) {
	...
	modal.find('.modal-body span').html('Tem certeza que deseja excluir a Categora <strong>' + descricaoEntidade + '</strong> e suas Tarefas?');
});
